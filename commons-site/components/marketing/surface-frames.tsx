...
export function MarketingSurfaceFrames({
  ...
  return (
    <section id="surfaces" className="scroll-mt-24 bg-zinc-50 py-16 md:py-24">
            ...
            return (
              ...
              >
                <div className={`card-surface ${reverse ? 'lg:order-2' : ''}`}>
                  <p className="mb-2 block text-xs font-semibold uppercase tracking-wider text-emerald-900">
                    {surface.tagline}
                  </p>
                  ...
                  <ul className="mt-5 grid gap-2 sm:grid-cols-2">
                    {surface.benefits.map((benefit) => (
                      <li
                        key={benefit}
                        className="flex gap-2 text-sm font-normal leading-relaxed text-slate-700 md:text-base"
                      >
