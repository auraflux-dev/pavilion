...
const DOCS = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'h1',   text: 'Where to Go' },
      { type: 'body',  text: 'Recommended for day-to-day toggles: Staff top nav → Programs (open/close registration, featured on homepage).' },
      { type: 'body',  text: 'Full program create / field edit: Wix Dashboard → Content Manager → Programs, then use Staff → Programs for registration and featured toggles.' },
      { type: 'h1',   text: 'What This Controls' },
      { type: 'body',  text: 'The /programs page (full grid) and the Programs Preview section on the homepage (featured programs only).' },
      { type: 'h1',   text: 'Staff day-to-day (recommended)' },
      { type: 'body',  text: '1. Sign in with @shmspto.org → Staff top nav → Programs.' },
      { type: 'body',  text: '2. On the Programs tab, toggle Registration open and Featured for each program.' },
      { type: 'body',  text: '3. Creating a brand-new program still starts in Content Manager → Programs; use Staff toggles after it exists.' },
      { type: 'h1',   text: 'Fields Explained' },
      ...
      { type: 'body',  text: 'featured — Check to show on homepage preview (keep to 3–4 max). Also toggleable in Staff → Programs.' },
      ...
      { type: 'body',  text: '4. Set featured = checked if it should appear on the homepage (or toggle Featured in Staff → Programs)' },
      { type: 'body',  text: '5. Set sortOrder' },
      { type: 'body',  text: '6. Save, then confirm registration/featured toggles under Staff → Programs' },
...

  {
    ...
    content: [
      ...
      { type: 'body', text: 'Workspaces (role-gated — you only see what your roles unlock): Home, Projects, Members, Staff access, Social, Surveys, Messages, Minutes, Programs, Payments, Events, Store & spirit, Page copy, Help.' },
      ...
      { type: 'body', text: 'Also see: 12b Payments / store card · 13 Page copy · 15 Sessions · 16 Messages · 19 Minutes · 21 Store & spirit · 23–25 Surveys & Social.' },
...

  {
    ...
    content: [
      ...
      { type: 'body', text: 'programs, instructor, admin. Registration / featured toggles + Sessions tab. Docs 02, 15.' },
      { type: 'h1', text: 'Payments' },
      { type: 'body', text: 'treasurer, admin. Needs Reconciliation — Retry gift-card load / Mark reconciled. Doc 12b.' },
      { type: 'h1', text: 'Events' },
      { type: 'body', text: 'events, secretary, marketing, admin. Upcoming list + Manage in Wix Events. Doc 07.' },
      { type: 'h1', text: 'Store & spirit' },
      { type: 'body', text: 'retail, admin. Product UUID allowlists. Doc 21.' },
      { type: 'h1', text: 'Page copy' },
      { type: 'body', text: 'marketing, secretary, admin. Heroes and marketing Page Content. Doc 13.' },
      { type: 'h1', text: 'Help' },
  ...
  // ── Index doc ─────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: 'body',  text: 'Last updated: July 17, 2026  |  Questions? Email gregory.robert.c@gmail.com' },
      { type: 'body',  text: 'Staging site: https://shmspto.vercel.app  |  After DNS: https://www.shmspto.org' },
      ...
      { type: 'body',  text: 'Staff tools also covered in: 12b Payments · 13 Page copy · 15 Sessions · 16 Messages · 19 Minutes · 21 Store & spirit · 23–25 Surveys & Social' },
      { type: 'body',  text: '27 - Member Portal Parent Support Guide (helping parents — separate MemberShell)' },
