...
const DOCS = [
...

  {
    ...
    content: [
      ...
      { type: 'body', text: '2. An admin signs in → Staff → Admin · Staff access.' },
      { type: 'body', text: '3. Enter the @shmspto.org email, name, board title, choose roles, keep Active checked, then Save staff access.' },
