...
const DOCS = [
...

  {
    ...
    content: [
      ...
      { type: 'body', text: 'Built into Staff (/staff) — no Asana/Trello. Calendar-year projects with swimlanes, member assignment, and personal boards.' },
      { type: 'h1', text: 'Where to go' },
      { type: 'body', text: 'Sign in with your @shmspto.org email → Staff → Staff · Year project board.' },
      { type: 'h1', text: 'Three views' },
      { type: 'body', text: 'Year board — everyone sees all projects for the school year as swimlanes.' },
      { type: 'body', text: 'My board — tasks assigned to you, that you created, or on projects you lead.' },
      { type: 'body', text: 'Project — one project’s members and tasks.' },
      { type: 'h1', text: 'How to use it' },
      { type: 'body', text: '1. President / each VP adds a project for the year (e.g. Fall Festival). Pick members who will help.' },
      { type: 'body', text: '2. Add a task under that project. Talk with the person who needs to do it, then Assign — it appears on the year board, the project, and their My board.' },
      { type: 'body', text: '3. Assignees mark Done when finished. Project leads can edit members and mark the project done.' },
  ...
  // ── Index doc ─────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: 'body',  text: 'Last updated: July 16, 2026  |  Questions? Email gregory.robert.c@gmail.com' },
      ...
      { type: 'body',  text: '29 - Staff Year Project Board' },
