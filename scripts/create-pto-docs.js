...
const DOCS = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'body', text: '3. Save draft anytime. Use Publish for Facebook — it creates and publishes via Wix Social Publisher.' },
...

  {
    ...
    content: [
      ...
      { type: 'body', text: 'Choose Facebook (Instagram later), write the post, add optional image/link URLs, then Save draft or Publish. Prefer Wix Media Manager image URLs for photos.' },
