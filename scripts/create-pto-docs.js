...
const DOCS = [
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'body', text: '1. Marketing & SEO → Social → New Post.' },
      { type: 'body', text: '2. Choose Facebook, Instagram, or both.' },
      { type: 'body', text: '3. Add text and a square image (1080×1080 recommended).' },
      { type: 'body', text: '4. Preview each network. Publish now or schedule.' },
...

  {
    ...
    content: [
      ...
      { type: 'body', text: '1. Person must have a Wix member account (same email they use to log into shmspto.org).' },
      { type: 'body', text: '2. Content Manager → StaffRoles → New Item.' },
      { type: 'body', text: '3. email = login email (lowercase). roles = comma-separated system roles. boardTitle = public office. active = true.' },
