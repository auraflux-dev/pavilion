...
const DOCS = [
...

  {
    ...
    content: [
      ...
      { type: 'body', text: 'Everyone on Staff sees the shared school-year swimlanes. Presidents and VPs add projects; assign tasks to people after you talk. Full walkthrough: doc 29.' },
      { type: 'h1', text: 'Admin lookup, act-as, archive' },
      { type: 'body', text: 'Member search, Act as, and Archive / Restore students: doc 31.' },
...

  {
    ...
    content: [
      ...
      { type: 'body', text: '2. Open Staff in the nav (or go to /staff).' },
      { type: 'body', text: '3. Find Staff · Year project board.' },
...

  {
    ...
    content: [
      ...
      { type: 'body', text: 'First time: sign in with @shmspto.org → open /staff once. That registers you. An admin then checks your roles under Admin · Staff access.' },
      { type: 'h1', text: 'What you will see on Staff' },
      { type: 'body', text: 'Role home cards — what your position owns + a short This week list.' },
      { type: 'body', text: 'Year project board — shared school-year swimlanes (doc 29). Everyone sees this.' },
      { type: 'body', text: 'Admin only — Member lookup & act-as, Staff access, Archive students (doc 31).' },
      { type: 'body', text: 'Marketing — Facebook compose (Instagram when a second Wix social slot is available) — doc 25.' },
      { type: 'body', text: 'Marketing / secretary — Survey results + CSV — docs 23–24.' },
      { type: 'body', text: 'Programs / instructor / secretary — Message parents into the portal inbox — doc 16.' },
      { type: 'h1', text: 'Which doc to open' },
      { type: 'body', text: '26 - Staff Roles & Portal Workspaces — logins, roles, who sees which panel' },
      ...
      { type: 'body', text: '16 - Parent Messages · 23–25 - Surveys & Facebook · 12b - Store Card' },
      ...
      { type: 'body', text: '2. Add or join at least one project on the Year board for something you own.' },
      { type: 'body', text: '3. Assign one real task to a teammate after you talk with them — confirm it shows on their My board.' },
      { type: 'body', text: '4. If you are Marketing: draft (do not publish yet) a Facebook post from Staff.' },
      { type: 'body', text: '5. If you are Programs/instructor: send a test message to yourself as a parent audience if needed.' },
...

  {
    ...
    content: [
      ...
      { type: 'body', text: 'Only staff with the admin role. Other roles will not see Member lookup & act-as.' },
      { type: 'h1', text: 'Member lookup' },
      { type: 'body', text: '1. Staff → Admin · Member lookup & act-as.' },
      { type: 'body', text: '2. Search by parent email or student name.' },
  ...
  // ── Index doc ─────────────────────────────────────────────────────────────
  {
    ...
    content: [
      ...
      { type: 'body',  text: '26 - Staff Roles & Portal Workspaces (@shmspto.org login, roles, panels)' },
      { type: 'body',  text: '29 - Staff Year Project Board (swimlanes, assign tasks)' },
      { type: 'body',  text: '31 - Admin Lookup, Act-as & Student Archive' },
      { type: 'body',  text: '27 - Member Portal Parent Support Guide (helping parents)' },
      { type: 'body',  text: '16 - Parent Messages · 23–25 Surveys & Facebook · 12b Store Card' },
      ...
      { type: 'body',  text: 'Staff on /staff: docs 16, 23–27, 29–31, 12b (as needed)' },
      ...
      { type: 'body',  text: 'If it is words, links, dates, products, or CMS rows → Wix. If it is board day-to-day work → /staff + docs 30/26/29. If it needs Cursor or the Vercel Dashboard → docs 09 / 22.' },
    ],
  },
]
