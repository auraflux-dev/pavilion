...
- Plaid: **stay on Trial until paying Commons clients** (Plaid said that is fine). Trial cap 10 Items. Set `PLAID_TRANSACTIONS_ITEM_USD_MONTH` from Billing when we leave Trial. Until then the sheet uses the mid of the $15–40 planning band ($27.50).
