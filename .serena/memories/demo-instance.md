...
Do **not** use Clerk. Demo users are signed review cookies (`demo_review`), not a third-party IdP. Staff Members roster is the sample CRM (Nguyen/Patel paid, Brooks free).
