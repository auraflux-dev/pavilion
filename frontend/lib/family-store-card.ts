/**
 * Cove store card is one Square gift card + one balance per family (parentEmail).
 * Student rows mirror the same GAN/balance so any sibling record stays in sync.
 */
