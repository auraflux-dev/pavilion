...
export const STAFF_ONBOARDING_TRACKS: Record<StaffOnboardingRole, StaffOnboardingTrack> = {
  ...
  programs: {
    ...
    steps: [
      ...sharedStart('prg'),
      {
        ...
        detail: 'Registration, roster, nights, and session lists for every class.',
        workspace: 'programs',
        actionLabel: 'Open Programs',
      },
      {
        id: 'prg_instructors',
        title: 'Add instructors in Staff access',
        detail:
          'Google mailbox first, then Access: role Instructor and their program ID. They only see that class.',
        workspace: 'access',
  ...
  instructor: {
    ...
    summary: 'Run your class: roster, parent messages, attendance, and hours.',
    steps: [
      ...sharedStart('ins'),
      {
        id: 'ins_programs',
        title: 'Open Programs → your class',
        detail: 'Roster tab is the class list. Confirm nights on the Fall 2026 schedule at the top.',
        workspace: 'programs',
        actionLabel: 'Open Programs',
      },
      {
        ...
        detail: 'Programs → message class, or Messages for replies in the parent portal inbox.',
        workspace: 'messages',
        actionLabel: 'Open Messages',
      },
      {
        id: 'ins_attendance',
        title: 'Take attendance on class night',
        detail: 'Programs → Attendance. Mark present / absent / late, then save.',
        workspace: 'programs',
        actionLabel: 'Open Programs',
      },
      {
        id: 'ins_timesheets',
        title: 'Submit hours after you teach',
        detail: 'Timesheets → your class and clock times. VP Programs approves pay.',
