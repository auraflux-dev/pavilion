 ...
 { key: 'tierId', label: 'Tier ID (slug. do not change after sales)', type: 'text', required: true },
  ...
  NewsletterTemplates: {
    ...
    fields: [
      ...
      { key: 'body', label: 'Email body (plain text)', type: 'textarea', required: true },
      {
        key: 'utmCampaign',
        label: 'UTM campaign slug',
        type: 'text',
        hint: 'e.g. run-for-charity-2026 (used for GA4 link tagging)',
      },
      { key: 'canvaDesignId', label: 'Canva design ID', type: 'text' },
      { key: 'canvaTitle', label: 'Canva design title', type: 'text' },
  ...
  NewsletterSends: {
    ...
    fields: [
      ...
      { key: 'sentByEmail', label: 'Sent by', type: 'text' },
  ...
  NewsletterJobs: {
    id: 'NewsletterJobs',
    label: 'Newsletter jobs (schedule / approval)',
    roles: ['marketing', 'secretary', 'membership', 'admin'],
    sortField: 'sendAt',
    activeField: 'active',
    fields: [
      { key: 'subject', label: 'Subject', type: 'text', required: true },
      { key: 'sendAt', label: 'Send at (ISO)', type: 'text', required: true },
      {
        key: 'status',
        label: 'Status',
        type: 'select',
      ...
      { key: 'createdByEmail', label: 'Created by', type: 'text' },
      { key: 'createdByName', label: 'Created by name', type: 'text' },
      { key: 'approvedByEmail', label: 'Approved by', type: 'text' },
      { key: 'approvedAt', label: 'Approved at', type: 'text' },
      { key: 'sentAt', label: 'Sent at', type: 'text' },
      { key: 'error', label: 'Last error', type: 'textarea' },
      { key: 'payloadJson', label: 'Payload JSON', type: 'textarea' },
      { key: 'active', label: 'Active', type: 'boolean' },
    ],
  },
  StaffCalendarSources: {
    id: 'StaffCalendarSources',
    label: 'EP planning calendars',
    roles: ['programs', 'coordinator', 'admin'],
    sortField: 'name',
    activeField: 'active',
    fields: [
      { key: 'name', label: 'Name', type: 'text', required: true },
      { key: 'kind', label: 'Kind (ics_url | ics_paste)', type: 'text', required: true },
      { key: 'sourceUrl', label: 'ICS / webcal URL', type: 'text' },
      { key: 'tone', label: 'Chip tone', type: 'text' },
      { key: 'active', label: 'Active', type: 'boolean' },
      { key: 'refreshedAt', label: 'Refreshed at (ISO)', type: 'text' },
      { key: 'lastError', label: 'Last error', type: 'textarea' },
      { key: 'cachedEventsJson', label: 'Cached events JSON', type: 'textarea' },
...
export const SITE_SETTING_GROUPS: {
 ...
 { key: 'schoolInSession', label: 'School in session (true/false). shows Programs & Events' },
      ...
      { key: 'announcementText', label: 'Banner text (use [label](/path) for links)', multiline: true },
  ...
  },
  {
    ...
    keys: [
      ...
      },
      {
        ...
        label: 'Volunteer signup inbox (from Site Settings)',
      },
      {
