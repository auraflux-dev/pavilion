...
export const WORKSPACE_MAILBOXES: WorkspaceMailbox[] = [
  ...
  { email: 'ep-youngentrepreneurs@shmspto.org', displayName: 'EP Young Entrepreneurs Instructor', group: 'ep', note: 'Fall 2026 YE · Missy Spears' },
  { email: 'ep-essaycomposition@shmspto.org', displayName: 'EP Essay Composition Instructor', group: 'ep', note: 'Fall 2026 Essay · Lumi (Andrew Martineau)' },
  ...
  { email: 'initiatives-coordinator@shmspto.org', displayName: 'Reshma Deshmukh · Initiatives Coordinator', group: 'board', note: 'Enrichment programs · instructor onboarding · /board' },
