...
import { DEMO_URL } from '@/lib/pavilion-site/pricing'
...
export const SURFACES = [
  ...
  },
  {
    ...
    benefits: [
      ...
      'Role-based permissions: Delegate event, volunteer, and store queues to chairs without exposing board settings.',
      'Reports and year history',
      'One-click audit trails: Instant itemized accounting exports for dues, tickets, and donations tied directly to Square.',
