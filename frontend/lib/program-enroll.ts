...
export type { StudentSafety } from '@/lib/student-safety'
export { studentSafetyComplete } from '@/lib/student-safety'
import { studentSafetyComplete, type StudentSafety } from '@/lib/student-safety'
