...
export const DEMO_PROGRAMS: Program[] = [
  {
    ...
    description: `Clay, paint, and sketch for grades 6 to 8. ${b.short} supplies the room.`,
    fee: 85,
    capacity: 16,
  ...
  {
    _id: 'demo-prog-code',
    name: 'Intro to coding club',
    description: 'Laptops provided. No experience needed. Member priority the first week.',
    fee: 40,
    capacity: 20,
    registrationOpen: true,
