...
export const DEMO_SETTINGS: Record<string, string> = {
  ...
  contactStoreHours: 'Mon to Fri · lunch periods',
  storeHours: 'Mon to Fri · lunch periods',
...
export const DEMO_NAV: NavLink[] = [
  ...
  { id: 'd4', label: b.store, href: '/perch', sortOrder: 4, showInNav: true, showInFooter: true, active: true },
  { id: 'd9', label: 'Contact', href: '/contact', sortOrder: 9, showInNav: false, showInFooter: true, active: true },
...
export const DEMO_PAGES: Record<string, PageContentFields> = {
  ...
  store: empty('store', {
    ...
    bullets: [
      'Free family login required to load a card',
...
export const DEMO_EVENTS: WixEvent[] = [
  {
    ...
    mainImage: { url: '/demo/community.jpg' },
