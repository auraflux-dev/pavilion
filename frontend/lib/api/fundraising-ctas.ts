...
const FALLBACK_CTAS: FundraisingCTA[] = [
  ...
  { id: 'f2', title: 'Load the Store Card',description: "Load $20–$50 on your student's store card — they spend, PTO earns.",           ctaLabel: 'Load Card', href: '/store',       icon: 'ShoppingBag', sortOrder: 2, active: true },
