...
import { HERO_EYEBROW, HERO_HEADLINE, HERO_SUPPORT, SURFACES } from '@/lib/pavilion-site/marketing'
import { COMMONS_LIST_PRICE_USD, DEMO_URL } from '@/lib/pavilion-site/pricing'
import { BrowserFrame } from '@/components/pavilion-site/marketing/browser-frame'
