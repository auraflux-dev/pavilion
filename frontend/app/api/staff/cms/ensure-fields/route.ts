    ...
    for (const spec of [
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'tier', displayName: 'Tier filter', type: 'TEXT' },
          { key: 'grade', displayName: 'Grade filter', type: 'TEXT' },
          { key: 'recipientCount', displayName: 'Recipients', type: 'NUMBER' },
          { key: 'deliveredCount', displayName: 'Delivered', type: 'NUMBER' },
          { key: 'failedCount', displayName: 'Failed', type: 'NUMBER' },
          { key: 'openCount', displayName: 'Opens', type: 'NUMBER' },
          { key: 'clickCount', displayName: 'Clicks', type: 'NUMBER' },
          { key: 'sentAt', displayName: 'Sent at', type: 'TEXT' },
          { key: 'sentByEmail', displayName: 'Sent by', type: 'TEXT' },
      ...
      },
      {
        ...
        fields: [
          ...
          { key: 'canvaThumbnailUrl', displayName: 'Canva thumbnail', type: 'TEXT' },
      ...
      },
      {
        ...
        fields: [
          { key: 'subject', displayName: 'Subject', type: 'TEXT' },
          { key: 'body', displayName: 'Body', type: 'TEXT' },
          { key: 'sendAt', displayName: 'Send at', type: 'TEXT' },
          { key: 'status', displayName: 'Status', type: 'TEXT' },
